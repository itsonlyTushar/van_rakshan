                ...
                <div className="text-white py-6 px-4">
                  ...
                  <div className="flex items-end justify-between gap-3 mt-10">
                    <div className="flex items-center">
                      ...
                      <h2 className="sm:text-sm text-xs max-w-sm w-10">
                        {event.location}
                      </h2>
                    </div>
                    ...
                    <Link to={"/contact"}>
                      {" "}
                      <button className="py-1 px-2 rounded-xl bg-[#9DC08B] hover:bg-[#b1cba4] ease-in-out transition-all max-w-lg w-full">
                        Contact us
                      </button>{" "}
                    </Link>
                  </div>
